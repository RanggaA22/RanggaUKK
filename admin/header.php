<nav class="navbar navbar-expand border-bottom border-body bg-dark sticky-top" data-bs-theme="">
  <a class="navbar-brand text-light" href="./"><img src="../file/img/merek.png" style="width:50px; height: 50px;" alt=""> Bumbu Makanan Enak</a>
                ...
                <form class="text-center needs-validation" novalidate action="../proses/ubah-password.php" method="POST">
                  ...
                  <div class="col-lg-6">
                      <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingInput" placeholder="Rangga21" name="username"
