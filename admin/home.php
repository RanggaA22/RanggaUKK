...
<div class="col-lg-9 mt-2">
    <div class="card">
        <h5 class="card-header bg-warning ">Home</h5>
        <div class="card-body">
...
<?php }else{ ?>
<!-- chart -->
<div class="col-lg-9 mt-3" id="chart">
                ...
                new Chart(ctx, {
                    ...
                    data: {
                        ...
                        datasets: [{
                            ...
                            borderWidth: 5,
                            backgroundColor:['rgba(255, 0, 0, 1)', 'rgba(0, 0, 255, 1)', 'rgba(208, 255, 0, 1)', 'rgba(0, 255, 0, 1)', 'rgba(255, 0, 255, 1)', 'rgba(0, 0, 0, 1)']
                        }]
                    },
                    options: {
                        scales: {
