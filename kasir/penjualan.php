...
<div class="col-lg-9 mt-2">
    <div class="card">
        <h5 class="card-header bg-warning">Penjualan</h5>
        <div class="card-body">
            <div class="row">
                <div class="column d-flex justify-content-start">
                    <button class="btn btn-primary me-2" data-bs-toggle="modal" data-bs-target="#tambahpelanggan"> Tambah
                        Penjualan pelanggan</button>
                    <button class="btn btn-primary me-2" data-bs-toggle="modal" data-bs-target="#tambahpembeli"> Tambah
                        pembeli</button>
                </div>
            </div>
            <!-- modal tambah -->
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-floating mb-3">
                                            <input type="number" class="form-control" id="floatingInput"
                                                placeholder="Rangga" name="id_penjualan" required
...
<!-- modal pembelii -->
<div class="modal fade" id="tambahpembeli" tabindex="-1" aria-labelledby="exampleModalLabel"
aria-hidden="true">
<div class="modal-dialog modal-lg modal-fullscreen-md-down">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <form class="text-center needs-validation" novalidate action="proses/tambahpembeli.php"
                                method="POST">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-floating mb-3">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary"
                                    data-bs-dismiss="modal">Close</button>
                                    <button type="submit" class="btn btn-primary" name="Tambah_Pembeli_validate"
                                    value="1234">Tambah Penjualan</button>
                                </div>
                            </form>
                        </div>
...
<!-- modal edit -->
            ...
            <?php } ?>
            <p class="mt-5 mb-3 text-body-secondary text-center">&copy; koyur</p>
        </div>
    </div>
</div>
